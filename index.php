...
<body>
    ...
    <div> 
        <nav class="navbar navbar-expand-l navbar-dark bg-light col-md-12">
                ...
                <div>
                    ...
                    <form action="index.php?precio=1" method="post">
                        <div class="navbar-brand dropdown">
                            <button class="btn btn-default dropdown-toggle text-dark" data-toggle="dropdown" href="#" role="button" aria-haspopup="true" aria-expanded="false">Precio</button>
                                <div class="dropdown-menu">
                                    <a class="dropdown-item" type="submit" value="asfdasdfwq1222">0-30,000</a>
    ...
    <div class="" id="Encontrados">
        <div class="d-flex justify-content-center">
            <h1 class="font-weight-bold text-dark mt-2" id="enc" >Encontrados</h1>
        </div>
        ...
        <div class="d-flex justify-content-center">
            <div class="col-sm-10 ml-4">
                        ...
                        <div class="container-fluid padding">
                            <div class="row padding mt-4" id="lista_enc">
                            
                                <script src="buscarPrec.js"></script>
                            </div>
                        </div>
            </div>
        </div>
    ...
    <script type="text/javascript">
        ...
        var precio='<?php echo $_GET["precio"]; ?>';
        if(precio==""){
            $('#Encontrados').hide();
        }
